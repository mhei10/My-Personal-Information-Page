    ...
    if (greetBtn && greetingMessage) {
        greetBtn.addEventListener("click", function () {
            greetingMessage.textContent =
                "Hello there! I'm Arriane Mhei, a Third Year College IT student majoring in Business Analytics who does her best on learning and still learning about business analytics. I love to explore the technology to learn and gain new knowledge about it.";
        });
    }
